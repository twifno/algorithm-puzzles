=begin rdoc
    ...
    This library implements a Fibonacci heap, which allows O(1) complexity for most methods.
		...
		This implementation comes from Kanwei's algorithm library: https://github.com/kanwei/algorithms
=end
class FibonacciHeap
  # no mean to implement each	
  # include Enumerable
  ...
  #     heap.pop #=> 1
  def merge!(otherheap)
    raise ArgumentError, "Trying to merge a heap with something not a heap" unless otherheap.kind_of? FibonacciHeap
